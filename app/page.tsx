...
export default function Home() {
  ...
  return <main>
    ...
    <footer className="shell"><div className="brand"><span>COLECTIVO</span><span>GRÁFICO</span><span>MALLORCA</span></div><p><Link href="/privacy">{t.footer.privacy}</Link> · <Link href="/legal">{t.footer.legal}</Link> · <Link href="/returns">{t.footer.returns}</Link></p><p>Artà · Mallorca · © 2026</p></footer>
  </main>;
}
