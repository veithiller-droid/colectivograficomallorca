...
export default function Home() {
  return <main>
    ...
    <footer className="shell"><div className="brand"><span>COLECTIVO</span><span>GRÁFICO</span><span>MALLORCA</span></div><p><a href="/privacy">Privacidad</a> · <a href="/legal">Aviso legal</a></p><p>Artà · Mallorca · © 2026</p></footer>
  </main>;
}
