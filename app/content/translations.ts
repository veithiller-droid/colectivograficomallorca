...
export const translations = {
  ...
  es: {
    ...
    product: { eyebrow: "Fine Art Print · Mallorca", description: "Impresión artística de alta calidad, diseñada, seleccionada y producida en Mallorca. El motivo se imprime cuidadosamente en el formato elegido sobre papel de calidad.", format: "Formato", cart: "Añadir a la cesta", technical: "Información técnica", product: "Producto", artist: "Artista", origin: "Origen", shipping: "Envío", shippingValue: "Directamente desde Mallorca" },
