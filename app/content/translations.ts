...
export const translations = {
  ...
  es: {
    ...
    product: { eyebrow: "Fine Art Print · Mallorca", description: "Impresión artística de alta calidad, diseñada, seleccionada y producida en Mallorca. El motivo se imprime cuidadosamente en el formato elegido sobre papel de calidad.", format: "Formato", printPrice: "Precio de la lámina · precios de los marcos próximamente", frame: "Enmarcación", unframed: "Sin marco", standardFrame: "Marco estándar negro", aluminiumFrame: "Aluminio con cristal", customFrame: "Marco personalizado", frameColor: "Color del marco", realGlass: "Cristal auténtico", colors: { silver: "Plata", black: "Negro", gold: "Oro" }, frameValues: { unframed: "Sin marco", standard: "Marco estándar negro", aluminium: "Aluminio con cristal auténtico", custom: "Marco personalizado de Art i Vases" }, customInfo: "Enmarcación individual realizada por Art i Vases en Artà. El perfil, el color, el paspartú y el cristal se eligen para cada obra.", request: "Solicitar enmarcación personalizada", cart: "Añadir a la cesta", technical: "Información técnica", product: "Producto", artist: "Artista", origin: "Origen", shipping: "Envío", shippingValue: "Directamente desde Mallorca" },
