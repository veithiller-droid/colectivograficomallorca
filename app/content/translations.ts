...
export const translations = {
  de: {
    ...
    shop: { eyebrow: "Kollektion", title: "Fine Art Prints", intro: "Gestaltet, ausgewählt, gedruckt und direkt aus Mallorca versendet.", all: "Alle", artists: "Künstler", formats: "Formate", recent: "Neueste", artist: "Künstler", from: "ab" },
  ...
  es: {
    ...
    shop: { eyebrow: "Colección", title: "Fine Art Prints", intro: "Creados, seleccionados, impresos y enviados directamente desde Mallorca.", all: "Todos", artists: "Artistas", formats: "Formatos", recent: "Más recientes", artist: "Artista", from: "Desde" },
