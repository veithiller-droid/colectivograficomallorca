...
export const translations = {
  de: {
    nav: { shop: "Shop", who: "Wer wir sind", what: "Was wir tun", newsletter: "Newsletter", bag: "Warenkorb" },
    home: {
      eyebrow: "Kunst und Grafik aus Mallorca",
      title1: "Die Insel,", title2: "gedruckt.",
      intro: "Fine Art Prints von Künstlern, die auf Mallorca geboren wurden oder die Insel zu ihrer Heimat gemacht haben. Hochwertig produziert und direkt von Mallorca versendet.",
      ...
      whoText: "Colectivo Gráfico Mallorca ist eine lokale Plattform für Kunst, Illustration und grafisches Design aus Mallorca. Unsere Künstler sind Blanca Colina, Herví Tille, Mateo Vilar und Miquel Salat.", whoLink: "Mehr über uns",
    ...
    who: {
      ...
      paragraphs: [
        ...
        "Unsere Künstler sind Blanca Colina, Herví Tille, Mateo Vilar und Miquel Salat. Ausführliche Künstlerporträts und Lebensläufe werden später ergänzt.",
      ...
      blancaBio: "Blanca Colina lebt und arbeitet auf Mallorca. Ihre Arbeiten entstehen auf der Insel und sind von der visuellen Welt Mallorcas und des Mittelmeers geprägt. Farben, Formen, Alltagsszenen und lokale Motive übersetzt sie in eine persönliche, grafische Bildsprache. Jedes Design zeigt ihre eigene Perspektive auf das mediterrane Leben – geschaffen, um ein Stück Mallorca in alltägliche Räume zu bringen."
    },
    what: {
      eyebrow: "Was wir tun", title: "Lokal entwickelt, hochwertig produziert.",
      paragraphs: [
        "Colectivo Gráfico Mallorca wählt künstlerische Arbeiten aus, bereitet sie für unterschiedliche Editionen und Formate auf und übernimmt ihre Präsentation, Produktion und Vermarktung.",
  ...
  es: {
    nav: { shop: "Tienda", who: "Quiénes somos", what: "Qué hacemos", newsletter: "Newsletter", bag: "Cesta" },
    home: {
      eyebrow: "Arte y obra gráfica de Mallorca",
      title1: "La isla,", title2: "impresa.",
      intro: "Fine Art Prints de artistas nacidos en Mallorca o que han hecho de la isla su hogar. Producidos con materiales de calidad y enviados directamente desde Mallorca.",
      ...
      whoText: "Colectivo Gráfico Mallorca es una plataforma local de arte, ilustración y diseño gráfico de Mallorca. Nuestros artistas son Blanca Colina, Herví Tille, Mateo Vilar y Miquel Salat.", whoLink: "Conocer el proyecto",
    ...
    who: {
      ...
      paragraphs: [
        ...
        "Nuestros artistas son Blanca Colina, Herví Tille, Mateo Vilar y Miquel Salat. Los retratos y las biografías completas se añadirán más adelante.",
      ...
      blancaBio: "Blanca Colina vive y trabaja en Mallorca. Sus obras nacen en la isla y están inspiradas en el universo visual de Mallorca y del Mediterráneo. Traduce colores, formas, escenas cotidianas y motivos locales a un lenguaje gráfico personal. Cada diseño muestra su propia perspectiva de la vida mediterránea, creado para llevar un pequeño fragmento de Mallorca a los espacios cotidianos."
    },
    what: {
      eyebrow: "Qué hacemos", title: "Desarrollado localmente, producido con calidad.",
      paragraphs: [
        "Colectivo Gráfico Mallorca selecciona obras artísticas, las adapta a diferentes ediciones y formatos y se encarga de su presentación, producción y comercialización.",
